...
for g in gases:
    ...
    top10 = top10.to_html(full_html=False, include_plotlyjs='cdn')
...
fg.add_child(folium.Choropleth(geo_data=(open('/content/drive/MyDrive/india_states.json', 'r', encoding='utf-8-sig').read()), line_color='#665C67', fill_color='#9D7DA2'))
map.add_child(fg)
