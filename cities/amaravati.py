...
layout = html.Div(id='amravatiParent', children=[

    # html.Header(id='header', children=[
    #     html.H1("amravati")
    #     # html.Img(id='displayImage',src=app.get_asset_url(f"{rootDirectory}/Air-Quality-Index-Prediction/photos/amravati.jpg"))
    # ]),
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(className='cardBody', children=[
                    cardLayout(html.Div(
                        dcc.Graph(id='amravatiGasesLinedGraph', className='graphPlot', figure={})))
                ...
                dbc.Row(children=[
                    ...
                    dbc.Col(className='cardBody', children=[
                        cardLayout(html.Div(
                            dcc.Graph(id='amravatiGasesBoxPlot', className='graphPlot', figure={})))
                    ], width=7),

                    dbc.Col(className='cardBody', children=[
                        cardLayout(html.Div(
                            dcc.Graph(id='amravatiGasesMonthlyPlot', className='graphPlot', figure={})))
                    ], width=5)
                ]),
                html.Br(), html.Br(),

                dbc.Row(children=[
                    cardLayout(html.Iframe(srcDoc=AmravatiMainElements.html_arima(), style={
                        'height': '500px',
                        'width': '1450px',
                    })),
                    html.Br(), html.Br(),
                ...
                dbc.Row(children=[
                    cardLayout(html.Iframe(srcDoc=AmravatiMainElements.comparingScenarios(), style={
                        'height': '500px',
                        'width': '1450px',
                    })),
                    html.Br(), html.Br(),
...
def comparitiveAnalysis(value):
    if value == "rmse":
        srcDoc = AmravatiMainElements.comparativeAnalysisRMSE()
    elif value == "mape":
        srcDoc = AmravatiMainElements.comparativeAnalysisMAPE()
    elif value == "mae":
        srcDoc = AmravatiMainElements.comparativeAnalysisMAE()
    elif value == "me":
        srcDoc = AmravatiMainElements.comparativeAnalysisME()
    elif value == "mse":
        srcDoc = AmravatiMainElements.comparativeAnalysisMSE()
    elif value == "mpe":
        srcDoc = AmravatiMainElements.comparativeAnalysisMPE()
    else:
        srcDoc = None
...
@app.callback(
    [Output(component_id='amravatiGasesLinedGraph', component_property='figure'),
     Output(component_id='amravatiGasesBoxPlot', component_property='figure'),
     Output(component_id='amravatiGasesMonthlyPlot',
