...
city = pd.read_csv(r"C:\Users\DELL\Desktop\Text Editors & Softwares\Python\Dash\Air-Quality-Index-Prediction\datasets\Amritsar.csv")
...
layout = html.Div(id = 'parent', children = [
    ...
    html.Header(id='header', children=[
        html.Img(src=app.get_asset_url(r"C:\Users\DELL\Desktop\Text Editors & Softwares\Python\Dash\Air-Quality-Index-Prediction\photos\amritsar.jpg"))
    ]),
    ...
    html.Div(id='mainBody', children=[
        ...
        dbc.Card(
            dbc.CardBody(id= 'card', children=[
                ...
                dbc.Row(children=[
                    cardLayout(html.Iframe(srcDoc=AmritsarMainElements.comparativeAnalysis(), style={
                            'height':'500px',
                            'width':'1450px',
                        })
                    )
