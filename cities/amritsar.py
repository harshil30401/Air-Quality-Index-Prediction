    ...
    html.Div(id='mainBody', children=[
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(children=[
                    dbc.Collapse(id='amr-collapse', is_open=False, children=[
                        ...
                        cardLayout(
                            html.Iframe(id="amr-comp_analysis", srcDoc="", style={
                                'height': '500px',
                                'width': '1450px',
                            })
                        ),
...
@app.callback(
    Output(component_id='amr-comp_analysis', component_property='srcDoc'),
...
@app.callback(
    Output("amr-collapse", "is_open"),
    [Input("amr-collapse-button", "n_clicks")],
    [State("amr-collapse", "is_open")],
)
