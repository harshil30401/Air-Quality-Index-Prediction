    ...
    html.Div(id='mainBody', children=[
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(children=[
                    dbc.Collapse(id='ben-collapse', is_open=False, children=[
                        ...
                        cardLayout(
                            html.Iframe(id="ben-comp_analysis", srcDoc="", style={
                                'height': '500px',
                                'width': '1450px',
                            })
                        ),
...
@app.callback(
    Output(component_id='ben-comp_analysis', component_property='srcDoc'),
...
@app.callback(
    Output("ben-collapse", "is_open"),
    [Input("ben-collapse-button", "n_clicks")],
    [State("ben-collapse", "is_open")],
)
