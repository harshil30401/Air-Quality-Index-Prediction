...
comparativeAnalysis = delhiMainElements.comparativeAnalysis()
html_arima = delhiMainElements.html_arima()
comparingScenarios = delhiMainElements.comparingScenarios()

def theBluePrint(cityNameCsv, theDisplayPhoto, comparativeAnalysis, html_arima, comparingScenarios):
        
    fontStyle = "Calibri"

    city = pd.read_csv(f"C:/Users/DELL/Desktop/Text Editors & Softwares/Python/Dash/Air-Quality-Index-Prediction/datasets/{cityNameCsv}.csv")
    ...
    photos = theDisplayPhoto
    assetURL = f"C:/Users/DELL/Desktop/Text Editors & Softwares/Python/Dash/Air-Quality-Index-Prediction/photos/{photos}.jpg"

    layout = html.Div(id = 'parent', children = [

        html.Header(id='header', children=[
            html.Img(src=app.get_asset_url(assetURL))
        ]),
        ...
        html.Div(id='mainBody', children=[
            ...
            dbc.Card(
                dbc.CardBody(id= 'card', children=[
                    ...
                    dbc.Row(children=[
                        cardLayout(html.Iframe(srcDoc = comparativeAnalysis, style={
                                'height':'500px',
                                'width':'1450px',
                            })
                        )
                    ...
                    dbc.Row(children=[
                        cardLayout(html.Iframe(srcDoc = html_arima, style={
                            'height':'500px',
                            'width':'1450px',
                        }))
                    ]),
                    ...
                    dbc.Row(children=[
                        cardLayout(html.Iframe(srcDoc = comparingScenarios, style={
                            'height':'500px',
                            'width':'1450px',
                        }))
                    ])
...
#     def bluePrintMethod(cityNameCsv, theDisplayPhoto):
#         return theBluePrint(cityNameCsv, theDisplayPhoto, comparativeAnalysis, html_arima, comparingScenarios)
