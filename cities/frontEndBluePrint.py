...
def frontend(
    ...
    startDate,    
    htmlArimaComponent,
    comparingScenariosComponent, 
    cityMainElements_comparativeAnalysisRMSE, 
    cityMainElements_comparativeAnalysisMAPE, 
    cityMainElements_comparativeAnalysisMAE, 
    cityMainElements_comparativeAnalysisME, 
    cityMainElements_comparativeAnalysisMSE, 
    cityMainElements_comparativeAnalysisMPE
    ):
    ...
    layout = html.Div(className= 'city', children=[
        ...
        # ]),
        headerComponent(cityName, startDate, math.floor(cityAQI[cityName])),

        html.Div(className='mainBody', children=[
            ...
            dbc.Card(
                dbc.CardBody(className='card', children=[

                    dbc.Row(className='cardBody', children=[
                        cardLayout(html.Div(
                            dcc.Graph(id=f'gasesLinedGraph{cityName}', className='graphPlot', figure={})))
                    ...
                    html.Div(className='buttonDiv', children=[
                        dbc.Button(
                    ...
                    dbc.Row(children=[
                        cardLayout(html.Iframe(srcDoc=comparingScenariosComponent, style={
                            'height': '500px',
                            'width': '1450px',
                        })),
                        html.Br(), html.Br(),
    ...
    def comparitiveAnalysis(value):
        if value == "rmse":
            srcDoc = cityMainElements_comparativeAnalysisRMSE
        elif value == "mape":
            srcDoc = cityMainElements_comparativeAnalysisMAPE
        elif value == "mae":
            srcDoc = cityMainElements_comparativeAnalysisMAE
        elif value == "me":
            srcDoc = cityMainElements_comparativeAnalysisME
        elif value == "mse":
            srcDoc = cityMainElements_comparativeAnalysisMSE
        elif value == "mpe":
            srcDoc = cityMainElements_comparativeAnalysisMPE
        else:
            srcDoc = None
    ...
    @app.callback(
        [Output(component_id=f'gasesLinedGraph{cityName}', component_property='figure'),
        Output(component_id=f'gasesBoxPlot{cityName}', component_property='figure'),
        Output(component_id=f'gasesMonthlyPlot{cityName}',component_property='figure')
        ],
