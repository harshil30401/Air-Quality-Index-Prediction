    ...
    html.Div(id='mainBody', children=[
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(children=[
                    dbc.Collapse(id='gan-collapse', is_open=False, children=[
                        ...
                        cardLayout(
                            html.Iframe(id="gan-comp_analysis", srcDoc="", style={
                                'height': '500px',
                                'width': '1450px',
                            })
                        ),
...
@app.callback(
    Output(component_id='gan-comp_analysis', component_property='srcDoc'),
...
@app.callback(
    Output("gan-collapse", "is_open"),
    [Input("gan-collapse-button", "n_clicks")],
    [State("gan-collapse", "is_open")],
)
