...
layout = html.Div(id='hyderabadParent', children=[

    # html.Header(id='header', children=[
    #     html.H1("Hyderabad")
    #     # html.Img(id='displayImage',src=app.get_asset_url(f"{rootDirectory}/Air-Quality-Index-Prediction/photos/hyderabad.jpg"))
    # ]),
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(className='cardBody', children=[
                    cardLayout(html.Div(
                        dcc.Graph(id='hyderabadGasesLinedGraph', className='graphPlot', figure={})))
...
def comparitiveAnalysis(value):
    if value == "rmse":
        srcDoc = HyderabadMainElements.comparativeAnalysisRMSE()
    elif value == "mape":
        srcDoc = HyderabadMainElements.comparativeAnalysisMAPE()
    elif value == "mae":
        srcDoc = HyderabadMainElements.comparativeAnalysisMAE()
    elif value == "me":
        srcDoc = HyderabadMainElements.comparativeAnalysisME()
    elif value == "mse":
        srcDoc = HyderabadMainElements.comparativeAnalysisMSE()
    elif value == "mpe":
        srcDoc = HyderabadMainElements.comparativeAnalysisMPE()
    else:
        srcDoc = None
...
@app.callback(
    [Output(component_id='hyderabadGasesLinedGraph', component_property='figure'),
     ...
     Output(component_id='hyderabadGasesMonthlyPlot',
