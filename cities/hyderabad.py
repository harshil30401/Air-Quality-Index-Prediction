            ...
            dbc.CardBody(id='card', children=[
                ...
                html.Div(id=f'buttonDiv{cityName}', children=[
                    dbc.Button(
                        ...
                        id=f"hyd-collapse-button{cityName}",
                        className="mb-3",
                        color="primary",
                        n_clicks=0,
                ...
                dbc.Row(children=[
                    dbc.Collapse(id=f'hyd-collapse{cityName}', is_open=False, children=[
...
@app.callback(
    Output(f"hyd-collapse{cityName}", "is_open"),
    [Input(f"hyd-collapse-button{cityName}", "n_clicks")],
    [State(f"hyd-collapse{cityName}", "is_open")],
)
