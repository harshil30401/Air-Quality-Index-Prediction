    ...
    html.Div(id='mainBody', children=[
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(children=[
                    dbc.Collapse(id='jod-collapse', is_open=False, children=[
                        ...
                        cardLayout(
                            html.Iframe(id="jod-comp_analysis", srcDoc="", style={
                                'height': '500px',
                                'width': '1450px',
                            })
                        ),
...
@app.callback(
    Output(component_id='jod-comp_analysis', component_property='srcDoc'),
...
@app.callback(
    Output("jod-collapse", "is_open"),
    [Input("jod-collapse-button", "n_clicks")],
    [State("jod-collapse", "is_open")],
)
