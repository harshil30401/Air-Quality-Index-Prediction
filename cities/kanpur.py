...
from backend.kanpurBackend import KanpurMainElements
...
layout = html.Div(id='kanpurParent', children=[

    # html.Header(id='header', children=[
    #     html.H1("Kanpur")
    #     # html.Img(id='displayImage',src=app.get_asset_url(f"{rootDirectory}/Air-Quality-Index-Prediction/photos/kanpur.jpg"))
    # ]),
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(className='cardBody', children=[
                    cardLayout(html.Div(
                        dcc.Graph(id='kanpurGasesLinedGraph', className='graphPlot', figure={})))
                ...
                dbc.Row(children=[
                    cardLayout(html.Iframe(srcDoc=KanpurMainElements.comparingScenarios(), style={
                        'height': '500px',
                        'width': '1450px',
                    })),
                    html.Br(), html.Br(),
...
def comparitiveAnalysis(value):
    if value == "rmse":
        srcDoc = KanpurMainElements.comparativeAnalysisRMSE()
    elif value == "mape":
        srcDoc = KanpurMainElements.comparativeAnalysisMAPE()
    elif value == "mae":
        srcDoc = KanpurMainElements.comparativeAnalysisMAE()
    elif value == "me":
        srcDoc = KanpurMainElements.comparativeAnalysisME()
    elif value == "mse":
        srcDoc = KanpurMainElements.comparativeAnalysisMSE()
    elif value == "mpe":
        srcDoc = KanpurMainElements.comparativeAnalysisMPE()
    else:
        srcDoc = None
...
@app.callback(
    [Output(component_id='kanpurGasesLinedGraph', component_property='figure'),
     Output(component_id='kanpurGasesBoxPlot', component_property='figure'),
     Output(component_id='kanpurGasesMonthlyPlot',
