...
layout = html.Div(id='patnaParent', children=[
    ...
    # ]),
    headerComponent(cityName, "June 2015", math.floor(cityAQI[cityName])),
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(className='cardBody', children=[
                    cardLayout(html.Div(
                        dcc.Graph(id='patnaGasesLinedGraph', className='graphPlot', figure={})))
...
@app.callback(
    [Output(component_id='patnaGasesLinedGraph', component_property='figure'),
     ...
     Output(component_id='patnaGasesMonthlyPlot',
