    ...
    html.Div(id='mainBody', children=[
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(children=[
                    dbc.Collapse(id='pun-collapse', is_open=False, children=[
                        ...
                        cardLayout(
                            html.Iframe(id="pun-comp_analysis", srcDoc="", style={
                                'height': '500px',
                                'width': '1450px',
                            })
                        ),
...
@app.callback(
    Output(component_id='pun-comp_analysis', component_property='srcDoc'),
...
@app.callback(
    Output("pun-collapse", "is_open"),
    [Input("pun-collapse-button", "n_clicks")],
    [State("pun-collapse", "is_open")],
)
