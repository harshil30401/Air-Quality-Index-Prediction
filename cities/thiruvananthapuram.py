...
from backend.thiruvananthapuramBackend import ThiruvananthapuramMainElements
...
layout = html.Div(id='thiruvananthapuramParent', children=[

    # html.Header(id='header', children=[
    #     html.H1("Thiruvananthapuram")
    #     # html.Img(id='displayImage',src=app.get_asset_url(f"{rootDirectory}/Air-Quality-Index-Prediction/photos/thiruvananthapuram.jpg"))
    # ]),
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(className='cardBody', children=[
                    cardLayout(html.Div(
                        dcc.Graph(id='thiruvananthapuramGasesLinedGraph', className='graphPlot', figure={})))
                ...
                dbc.Row(children=[
                    cardLayout(html.Iframe(srcDoc=ThiruvananthapuramMainElements.comparingScenarios(), style={
                        'height': '500px',
                        'width': '1450px',
                    })),
                    html.Br(), html.Br(),
...
def comparitiveAnalysis(value):
    if value == "rmse":
        srcDoc = ThiruvananthapuramMainElements.comparativeAnalysisRMSE()
    elif value == "mape":
        srcDoc = ThiruvananthapuramMainElements.comparativeAnalysisMAPE()
    elif value == "mae":
        srcDoc = ThiruvananthapuramMainElements.comparativeAnalysisMAE()
    elif value == "me":
        srcDoc = ThiruvananthapuramMainElements.comparativeAnalysisME()
    elif value == "mse":
        srcDoc = ThiruvananthapuramMainElements.comparativeAnalysisMSE()
    elif value == "mpe":
        srcDoc = ThiruvananthapuramMainElements.comparativeAnalysisMPE()
    else:
        srcDoc = None
...
@app.callback(
    [Output(component_id='thiruvananthapuramGasesLinedGraph', component_property='figure'),
     Output(component_id='thiruvananthapuramGasesBoxPlot', component_property='figure'),
     Output(component_id='thiruvananthapuramGasesMonthlyPlot',
