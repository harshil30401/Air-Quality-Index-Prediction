            ...
            dbc.CardBody(id='card', children=[
                ...
                html.Div(id=f'buttonDiv{cityName}', children=[
                    dbc.Button(
                        ...
                        id=f"thi-collapse-button{cityName}",
                        className="mb-3",
                        color="primary",
                        n_clicks=0,
                ...
                dbc.Row(children=[
                    dbc.Collapse(id=f'thi-collapse{cityName}', is_open=False, children=[
                        ...
                        cardLayout(
                            html.Iframe(id=f"thi-comp_analysis{cityName}", srcDoc="", style={
                                'height': '500px',
                                'width': '1450px',
                            })
                        ),
...
@app.callback(
    Output(component_id=f'thi-comp_analysis{cityName}', component_property='srcDoc'),
...
@app.callback(
    Output(f"thi-collapse{cityName}", "is_open"),
    [Input(f"thi-collapse-button{cityName}", "n_clicks")],
    [State(f"thi-collapse{cityName}", "is_open")],
)
