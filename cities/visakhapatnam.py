...
layout = html.Div(id='visakhapatnamParent', children=[

    # html.Header(id='header', children=[
    #     html.H1("Visakhapatnam")
    #     # html.Img(id='displayImage',src=app.get_asset_url(f"{rootDirectory}/Air-Quality-Index-Prediction/photos/visakhapatnam.jpg"))
    # ]),
    headerComponent(cityName, "October 2017", math.floor(cityAQI[cityName])),
        ...
        dbc.Card(
            dbc.CardBody(id='card', children=[
                ...
                dbc.Row(className='cardBody', children=[
                    cardLayout(html.Div(
                        dcc.Graph(id='visakhapatnamGasesLinedGraph', className='graphPlot', figure={})))
...
def comparitiveAnalysis(value):
    if value == "rmse":
        srcDoc = VisakhapatnamMainElements.comparativeAnalysisRMSE()
    elif value == "mape":
        srcDoc = VisakhapatnamMainElements.comparativeAnalysisMAPE()
    elif value == "mae":
        srcDoc = VisakhapatnamMainElements.comparativeAnalysisMAE()
    elif value == "me":
        srcDoc = VisakhapatnamMainElements.comparativeAnalysisME()
    elif value == "mse":
        srcDoc = VisakhapatnamMainElements.comparativeAnalysisMSE()
    elif value == "mpe":
        srcDoc = VisakhapatnamMainElements.comparativeAnalysisMPE()
    else:
        srcDoc = None
...
@app.callback(
    [Output(component_id='visakhapatnamGasesLinedGraph', component_property='figure'),
     Output(component_id='visakhapatnamGasesBoxPlot', component_property='figure'),
     Output(component_id='visakhapatnamGasesMonthlyPlot',
