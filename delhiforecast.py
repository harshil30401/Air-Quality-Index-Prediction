...
# "Prophet" : prophet_acc_parameters,

acc_parameters = {"ARIMA": arima_acc_parameters,  "LSTM" : lstm_acc_parameters, "ETS" : ets_acc_parameters}
...
# , 'Prophet':acc_parameters.rmse['Prophet']

dictionary = {'ARIMA':acc_parameters.rmse['ARIMA'], 
